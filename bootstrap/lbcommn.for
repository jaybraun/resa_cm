...
23688 CONTINUE
     ...
     *690
      IF(.NOT.(IADDR.EQ.-20567))GOTO 23692
      MSNCOD =1
      GOTO 23693
23692 CONTINUE
      ...
      GOTO 23695
23694 CONTINUE
      IF(.NOT.(IADDR.EQ.-20566))GOTO 23696
      MSNCOD =4
      GOTO 23697
23696 CONTINUE
...
23698 CONTINUE
      ...
      GOTO 23701
23700 CONTINUE
      IF(.NOT.(IADDR.EQ.-20466))GOTO 23702
      MSNCOD =7
      GOTO 23703
23702 CONTINUE
      IF(.NOT.(IADDR.EQ.-20588))GOTO 23704
      MSNCOD =8
      GOTO 23705
23704 CONTINUE
      IF(.NOT.(IADDR.EQ.-20481))GOTO 23706
      MSNCOD =11
      GOTO 23707
23706 CONTINUE
      IF(.NOT.(IADDR.EQ.-20575))GOTO 23708
      MSNCOD =12
      GOTO 23709
23708 CONTINUE
      IF(.NOT.(IADDR.EQ.-20303))GOTO 23710
      MSNCOD =13
      GOTO 23711
23710 CONTINUE
      ...
      GOTO 23713
23712 CONTINUE
      IF(.NOT.(IADDR.EQ.-20568))GOTO 23714
      MSNCOD=16
      GOTO 23715
23714 CONTINUE
      IF(.NOT.(IADDR.EQ.-20573))GOTO 23716
      MSNCOD =3
      GOTO 23717
23716 CONTINUE
      IF(.NOT.(IADDR.EQ.-20490))GOTO 23718
      MSNCOD =9
      GOTO 23719
23718 CONTINUE
      ...
      GOTO 23721
23720 CONTINUE
      IF(.NOT.(IADDR.EQ.-20518))GOTO 23722
      MSNCOD =14
      GOTO 23723
23722 CONTINUE
...
23732 CONTINUE
      ...
      GOTO 23735
23734 CONTINUE
      IF(.NOT.(IADDR.EQ.-20253))GOTO 23736
      MSNCOD =36
      GOTO 23737
23736 CONTINUE
      IF(.NOT.(IADDR.EQ.-20364))GOTO 23738
      MSNCOD =37
      GOTO 23739
23738 CONTINUE
      IF(.NOT.(IADDR.EQ.-20404))GOTO 23740
      MSNCOD=38
      GOTO 23741
23740 CONTINUE
      IF(.NOT.(IADDR.EQ.-20548))GOTO 23742
      MSNCOD=39
      GOTO 23743
23742 CONTINUE
      IF(.NOT.(IADDR.EQ.-20578))GOTO 23744
      MSNCOD=40
      GOTO 23745
23744 CONTINUE
      IF(.NOT.(IADDR.EQ.-20592))GOTO 23746
      MSNCOD=41
      GOTO 23747
23746 CONTINUE
      IF(.NOT.(IADDR.EQ.-20598))GOTO 23748
      MSNCOD=42
      GOTO 23749
23748 CONTINUE
      IF(.NOT.(IADDR.EQ.-20659))GOTO 23750
      MSNCOD =43
23750 CONTINUE
23749 CONTINUE
23747 CONTINUE
...
23865 CONTINUE
      ...
      GOTO 23868
23867 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20588))GOTO 23869
      MISSION_CODE =8
      GOTO 23870
23869 CONTINUE
...
23887 CONTINUE
      ...
      GOTO 23890
23889 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20253))GOTO 23891
      MISSION_CODE =36
      GOTO 23892
23891 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20303))GOTO 23893
      MISSION_CODE =13
      GOTO 23894
23893 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20364))GOTO 23895
      MISSION_CODE =37
      GOTO 23896
23895 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20395))GOTO 23897
      MISSION_CODE =0
      GOTO 23898
23897 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20404))GOTO 23899
      MISSION_CODE =38
      GOTO 23900
23899 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20427))GOTO 23901
      MISSION_CODE =37
      GOTO 23902
23901 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20466))GOTO 23903
      MISSION_CODE =7
      GOTO 23904
23903 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20481))GOTO 23905
      MISSION_CODE =11
      GOTO 23906
23905 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20490))GOTO 23907
      MISSION_CODE =9
      GOTO 23908
23907 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20516))GOTO 23909
      MISSION_CODE =45
      GOTO 23910
23909 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20517))GOTO 23911
      MISSION_CODE =46
      GOTO 23912
23911 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20518))GOTO 23913
      MISSION_CODE =14
      GOTO 23914
23913 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20548))GOTO 23915
      MISSION_CODE =39
      GOTO 23916
23915 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20566))GOTO 23917
      MISSION_CODE =4
      GOTO 23918
23917 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20567))GOTO 23919
      MISSION_CODE =1
      GOTO 23920
23919 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20568))GOTO 23921
      MISSION_CODE =16
      GOTO 23922
23921 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20573))GOTO 23923
      MISSION_CODE =3
      GOTO 23924
23923 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20575))GOTO 23925
      MISSION_CODE =12
      GOTO 23926
23925 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20578))GOTO 23927
      MISSION_CODE =40
      GOTO 23928
23927 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20592))GOTO 23929
      MISSION_CODE =41
      GOTO 23930
23929 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20598))GOTO 23931
      MISSION_CODE =42
      GOTO 23932
23931 CONTINUE
      IF(.NOT.(LEX_VALUE.EQ.-20659))GOTO 23933
      MISSION_CODE =43
      GOTO 23934
23933 CONTINUE
      MISSION_CODE =-1
