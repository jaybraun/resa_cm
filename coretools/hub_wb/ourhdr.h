...
static int		 tty_cbreak(int);			/* {Prog raw} */
static int		 tty_raw(int);				/* {Prog raw} */
static int		 tty_reset(int);			/* {Prog raw} */
static void	 tty_atexit(void);			/* {Prog raw} */
...
static void	err_dump(const char *, ...);	/* {App misc_source} */
