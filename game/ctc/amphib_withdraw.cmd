# amphib_withdraw   Test Case Amphibious Operations Withdraw Forces from LZ

# Build Ground objects must exist for this test procedure to work
#     SRLS
# LSD36 mapped to anchorage_lsd
# Create Amphib ship
CREATE SHIP LSD LSD36 4.5.11.30  37-51N 124-56E 0 0      
...
# Boat landing plan
FOR LSD LAUNCH BOAT 1 LCAC LC2LZ1      
LOAD 5 SRLS      
